namespace SKAnimatorTools {
	partial class MainWindow {
		...
		private void InitializeComponent() {
			...
			this.SilkImages.Images.SetKeyName(11, "SoundWarning");
			this.SilkImages.Images.SetKeyName(12, "Attachment");
			this.SilkImages.Images.SetKeyName(13, "Derived");
			this.SilkImages.Images.SetKeyName(14, "Conditional");
			this.SilkImages.Images.SetKeyName(15, "CameraShake");
			this.SilkImages.Images.SetKeyName(16, "Generated");
			this.SilkImages.Images.SetKeyName(17, "Schemed");
			this.SilkImages.Images.SetKeyName(18, "SchemedModel");
			this.SilkImages.Images.SetKeyName(19, "Scheme");
			this.SilkImages.Images.SetKeyName(20, "Animation");
			this.SilkImages.Images.SetKeyName(21, "Scripted");
			this.SilkImages.Images.SetKeyName(22, "TimedAction");
			this.SilkImages.Images.SetKeyName(23, "Config");
			this.SilkImages.Images.SetKeyName(24, "Shading");
			this.SilkImages.Images.SetKeyName(25, "Reference");
			this.SilkImages.Images.SetKeyName(26, "Array");
			this.SilkImages.Images.SetKeyName(27, "Texture");
			this.SilkImages.Images.SetKeyName(28, "Variant");
			this.SilkImages.Images.SetKeyName(29, "Light");
			this.SilkImages.Images.SetKeyName(30, "Value");
			this.SilkImages.Images.SetKeyName(31, "Triangle");
			this.SilkImages.Images.SetKeyName(32, "Tile");
			this.SilkImages.Images.SetKeyName(33, "Matrix");
			this.SilkImages.Images.SetKeyName(34, "Vector3");
			this.SilkImages.Images.SetKeyName(35, "Vector4");
			this.SilkImages.Images.SetKeyName(36, "Missing");
			this.SilkImages.Images.SetKeyName(37, "Tag");
			this.SilkImages.Images.SetKeyName(38, "Wrench");
			this.SilkImages.Images.SetKeyName(39, "MissingConfig");
			this.SilkImages.Images.SetKeyName(40, "Editable");
			this.SilkImages.Images.SetKeyName(41, "RedTag");
			this.SilkImages.Images.SetKeyName(42, "None");
			// 
			// GroupBoxModelInfo
			// 
