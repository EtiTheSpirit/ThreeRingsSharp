...
namespace ThreeRingsSharp.XansData.Extensions {
	...
	public static class EnumerableExtension {
		...
		public static TKey KeyOf<TKey, TValue>(this Dictionary<TKey, TValue> dictionary, TValue value) where TKey : notnull {
		...
		/// <returns></returns>
		public static TValue? GetOrDefault<TKey, TValue>(this Dictionary<TKey, TValue> dictionary, TKey key, TValue? def = default) where TKey : notnull {
		...
		/// <param name="def"></param>
		/// <returns></returns>
		public static TValue? GetOrDefault<TKey, TValue>(this IReadOnlyDictionary<TKey, TValue> dictionary, TKey key, TValue? def = default) where TKey : notnull {
			if (dictionary.ContainsKey(key)) return dictionary[key];
			return def;
		}
		#endregion
		...
		/// <returns></returns>
		public static bool ContainsValueOfType<TKey, TValue>(this Dictionary<TKey, TValue> dictionary, Type valueType) where TKey : notnull {
		...
		/// <param name="dictionary"></param>
		/// <param name="value"></param>
		public static void Remove<TKey, TValue>(this Dictionary<TKey, TValue> dictionary, TValue value) where TKey : notnull => dictionary.Remove(dictionary.KeyOf(value));
